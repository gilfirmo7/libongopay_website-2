...
export default function PaymentCompaniesPage() {
  ...
  const features = [
    { icon: Zap, title: t.solutionPages.paymentCompanies.whyChooseItems[0], desc: t.solutionPages.paymentCompanies.whyChooseItems[0] },
    { icon: Globe, title: t.solutionPages.paymentCompanies.whyChooseItems[1], desc: t.solutionPages.paymentCompanies.whyChooseItems[1] },
    { icon: Shield, title: t.solutionPages.paymentCompanies.whyChooseItems[2], desc: t.solutionPages.paymentCompanies.whyChooseItems[2] },
    { icon: DollarSign, title: t.solutionPages.paymentCompanies.whyChooseItems[3], desc: t.solutionPages.paymentCompanies.whyChooseItems[3] },
    { icon: BarChart, title: t.solutionPages.paymentCompanies.whyChooseItems[4], desc: t.solutionPages.paymentCompanies.whyChooseItems[4] },
    { icon: Settings, title: t.solutionPages.paymentCompanies.whyChooseItems[5], desc: t.solutionPages.paymentCompanies.whyChooseItems[5] },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-white">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6">{t.solutionPages.paymentCompanies.title}</h1>
              <p className="text-lg sm:text-xl md:text-2xl text-white/80 mb-6 md:mb-8">
                {t.solutionPages.paymentCompanies.subtitle}
              </p>
              <Link href="/#contact" className="inline-flex items-center justify-center bg-[#F9A825] hover:bg-[#F9A825]/90 text-gray-900 font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-full text-sm sm:text-base">
                {t.solutionPages.paymentCompanies.ctaButton} <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5" />
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">
              {t.solutionPages.paymentCompanies.section1Title}
            </h2>
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
              {t.solutionPages.paymentCompanies.section1Desc}
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6">{t.solutionPages.paymentCompanies.whyChooseTitle}</h2>
              <div className="space-y-3 sm:space-y-4">
                {t.solutionPages.paymentCompanies.whyChooseItems.map((item, index) => (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 md:mb-6">
              {t.solutionPages.paymentCompanies.ctaTitle}
            </h2>
            <p className="text-base sm:text-lg text-gray-600 mb-6 md:mb-8 px-4">
              {t.solutionPages.paymentCompanies.ctaDesc}
            </p>
