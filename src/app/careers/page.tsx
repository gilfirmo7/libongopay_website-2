        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-xl text-white/80 mb-8">
              Help us build the future of digital payments in Africa. We're looking for talented individuals who are passionate about fintech and financial inclusion.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              { title: "Innovation", desc: "We're constantly pushing boundaries and finding new solutions." },
              { title: "Inclusion", desc: "We believe in financial services accessible to everyone." },
              { title: "Integrity", desc: "We operate with transparency and ethical standards." },
              { title: "Collaboration", desc: "We work together across borders and cultures." },
